...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-xl': ['5rem', { lineHeight: '1.2', letterSpacing: '-0.02em', fontWeight: '700' }],
        'display-lg': ['3.75rem', { lineHeight: '1.1', letterSpacing: '-0.02em', fontWeight: '700' }],
        'display-md': ['2.75rem', { lineHeight: '1.2', letterSpacing: '-0.02em', fontWeight: '600' }],
        ...
        'heading-xs': ['1rem', { lineHeight: '1.35', fontWeight: '600' }],
